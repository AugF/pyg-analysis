...
from utils import survey, algorithms, variables, datasets, dicts
plt.style.use("ggplot")
plt.rcParams["font.size"] = 12

# 1. stages, layers, operators, edge-cal
def pics_others(label, columns, params):
...
def run_pics_others(params):
    for label in ['calculations', 'edge_cal']:
        pics_others(label, dicts[label], params)

# one pics
def pics_operators(params):
